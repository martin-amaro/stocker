...
export const MainTestimonial = () => {
    return (
        <section className="relative before:absolute before:inset-0 before:z-[-1] before:bg-gradient-to-b before:from-white before:via-[#f3f6fb] before:to-[#f3f6fb]">
            <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                ...
                <p className="px-6 py-2 text-2xl font-display font-bold text-center text-title sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl">
