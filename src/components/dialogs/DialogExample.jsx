...
import { SimpleInput } from '../dashboard/SimpleInput';
import { Select } from '@base-ui-components/react/select';

export const DialogExample = () => {
  const [open, setOpen] = useState(false); // si el modal está montado
  ...
  <Select.Root defaultValue="sans">
      ...
      <Select.Portal>
        <Select.Positioner className="outline-none z-100" sideOffset={8}>
