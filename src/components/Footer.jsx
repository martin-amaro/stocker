  ...
  const currentYear = new Date().getFullYear();
    ...
    <div className="flex flex-col w-[90%] max-w-[1400px] mx-auto ">
        <div className="w-full flex flex-wrap my-10 md:my-20">
          <div className="flex flex-col w-full mb-10 md:w-1/4 md:mb-0">
            <h3 className="footer-title">Servicios</h3>
            <ul className="flex flex-col gap-[0.7rem]">
              <li><a href="#" className="footer-lnk">Soluciones de Inventario</a></li>
              <li><a href="#" className="footer-lnk">Gestión de Stock</a></li>
              <li><a href="#" className="footer-lnk">Análisis de Productos</a></li>
              <li><a href="#" className="footer-lnk">Eficiencia en Almacén</a></li>
              <li><a href="#" className="footer-lnk">Roles</a></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col w-full mb-10 md:w-1/4 md:mb-0">
            ...
            <ul className="flex flex-col gap-[0.7rem]">
              <li><a href="#" className="footer-lnk">Acerca de</a></li>
              <li><a href="#" className="footer-lnk">Aliados</a></li>
              <li><a href="#" className="footer-lnk">Licencias</a></li>
              <li><a href="#" className="footer-lnk">Términos</a></li>
            </ul>
          </div>
        </div>
